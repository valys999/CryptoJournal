 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cs(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function fp(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nb(n){Zi(new bi("platform-logger",t=>new Yy(t),"PRIVATE")),Zi(new bi("heartbeat",t=>new Mb(t),"PRIVATE")),Bn(Rl,_h,n),Bn(Rl,_h,"esm2020"),Bn("fire-js","")}Nb("");var Fb="firebase",$b="12.9.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vo=new uc("@firebase/auth");function zb(n,...t){Vo.logLevel<=lt.WARN&&Vo.warn(`Auth (${us}): ${n}`,...t)}function mo(n,...t){Vo.logLevel<=lt.ERROR&&Vo.error(`Auth (${us}): ${n}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xb(n,t){return hs(n,"POST","/v1/accounts:delete",t)}async function No(n,t){return hs(n,"POST","/v1/accounts:lookup",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function or(n,t,e=!1){if(e)return t;try{return await t}catch(i){throw i instanceof En&&Zb(i)&&n.auth.currentUser===n&&await n.auth.signOut(),i}}function Zb({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wi{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(t){Q(t.idToken,"internal-error"),Q(typeof t.idToken<"u","internal-error"),Q(typeof t.refreshToken<"u","internal-error");const e="expiresIn"in t&&typeof t.expiresIn<"u"?Number(t.expiresIn):Th(t.idToken);this.updateTokensAndExpiration(t.idToken,t.refreshToken,e)}updateFromIdToken(t){Q(t.length!==0,"internal-error");const e=Th(t);this.updateTokensAndExpiration(t,null,e)}async getToken(t,e=!1){return!e&&this.accessToken&&!this.isExpired?this.accessToken:(Q(this.refreshToken,t,"user-token-expired"),this.refreshToken?(await this.refresh(t,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(t,e){const{accessToken:i,refreshToken:s,expiresIn:r}=await iv(t,e);this.updateTokensAndExpiration(i,s,Number(r))}updateTokensAndExpiration(t,e,i){this.refreshToken=e||null,this.accessToken=t||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(t,e){const{refreshToken:i,accessToken:s,expirationTime:r}=e,o=new Wi;return i&&(Q(typeof i=="string","internal-error",{appName:t}),o.refreshToken=i),s&&(Q(typeof s=="string","internal-error",{appName:t}),o.accessToken=s),r&&(Q(typeof r=="number","internal-error",{appName:t}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(t){this.accessToken=t.accessToken,this.refreshToken=t.refreshToken,this.expirationTime=t.expirationTime}_clone(){return Object.assign(new Wi,this.toJSON())}_performRefresh(){return hn("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vp(n,t=[]){let e;switch(n){case"Browser":e=xh(he());break;case"Worker":e=`${xh(he())}-${n}`;break;default:e=n}const i=t.length?t.join(","):"FirebaseCore-web";return`${e}/JsCore/${us}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lv(n,t={}){return hs(n,"GET","/v2/passwordPolicy",mc(n,t))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ki(n,t){return Yb(n,"POST","/v1/accounts:signInWithIdp",mc(n,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(t){this.user=t.user,this.providerId=t.providerId,this._tokenResponse=t._tokenResponse,this.operationType=t.operationType}static async _fromIdTokenResponse(t,e,i,s=!1){const r=await Oe._fromIdTokenResponse(t,i,s),o=kh(i);return new ts({user:r,providerId:o,_tokenResponse:i,operationType:e})}static async _forOperation(t,e,i){await t._updateTokensIfNecessary(i,!0);const s=kh(i);return new ts({user:t,providerId:s,_tokenResponse:i,operationType:e})}}function kh(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function r0(n,t={}){return hs(n,"GET","/v1/projects",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O0(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function L0(n){Zi(new bi("auth",(t,{options:e})=>{const i=t.getProvider("app").getImmediate(),s=t.getProvider("heartbeat"),r=t.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;Q(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const l={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Vp(n)},u=new hv(i,s,r,l);return _v(u,e),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,i)=>{t.getProvider("auth-internal").initialize()})),Zi(new bi("auth-internal",t=>{const e=fa(t.getProvider("auth").getImmediate());return(i=>new M0(i))(e)},"PRIVATE").setInstantiationMode("EXPLICIT")),Bn(Vh,Nh,O0(n)),Bn(Vh,Nh,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ds="12.9.0";function z0(n){ds=n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ei=new uc("@firebase/firestore");function $i(){return Ei.logLevel}function $(n,...t){if(Ei.logLevel<=lt.DEBUG){const e=t.map(Tc);Ei.debug(`Firestore (${ds}): ${n}`,...e)}}function yn(n,...t){if(Ei.logLevel<=lt.ERROR){const e=t.map(Tc);Ei.error(`Firestore (${ds}): ${n}`,...e)}}function wi(n,...t){if(Ei.logLevel<=lt.WARN){const e=t.map(Tc);Ei.warn(`Firestore (${ds}): ${n}`,...e)}}function Tc(n){if(typeof n=="string")return n;try{return(function(e){return JSON.stringify(e)})(n)}catch{return n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fs(n){if(n.code!==N.FAILED_PRECONDITION||n.message!==iE)throw n;$("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qh(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function Ai(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function ag(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cg="server_timestamp",ug="__type__",hg="__previous_value__",dg="__local_write_time__";function Ac(n){var e,i;return((i=(((e=n==null?void 0:n.mapValue)==null?void 0:e.fields)||{})[ug])==null?void 0:i.stringValue)===cg}function ya(n){const t=n.mapValue.fields[hg];return Ac(t)?ya(t):t}function cr(n){const t=Gn(n.mapValue.fields[dg].timestampValue);return new Ct(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uE{constructor(t,e,i,s,r,o,a,l,u,h,d){this.databaseId=t,this.appId=e,this.persistenceKey=i,this.host=s,this.ssl=r,this.forceLongPolling=o,this.autoDetectLongPolling=a,this.longPollingOptions=l,this.useFetchStreams=u,this.isUsingEmulator=h,this.apiKey=d}}const jo="(default)";class ur{constructor(t,e){this.projectId=t,this.database=e||jo}static empty(){return new ur("","")}get isDefaultDatabase(){return this.database===jo}isEqual(t){return t instanceof ur&&t.projectId===this.projectId&&t.database===this.database}}function hE(n,t){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new H(N.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ur(n.options.projectId,t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pi{constructor(t,e){this.mapKeyFn=t,this.equalsFn=e,this.inner={},this.innerSize=0}get(t){const e=this.mapKeyFn(t),i=this.inner[e];if(i!==void 0){for(const[s,r]of i)if(this.equalsFn(s,t))return r}}has(t){return this.get(t)!==void 0}set(t,e){const i=this.mapKeyFn(t),s=this.inner[i];if(s===void 0)return this.inner[i]=[[t,e]],void this.innerSize++;for(let r=0;r<s.length;r++)if(this.equalsFn(s[r][0],t))return void(s[r]=[t,e]);s.push([t,e]),this.innerSize++}delete(t){const e=this.mapKeyFn(t),i=this.inner[e];if(i===void 0)return!1;for(let s=0;s<i.length;s++)if(this.equalsFn(i[s][0],t))return i.length===1?delete this.inner[e]:i.splice(s,1),this.innerSize--,!0;return!1}forEach(t){Ai(this.inner,((e,i)=>{for(const[s,r]of i)t(s,r)}))}isEmpty(){return ag(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CE=new Lt(W.comparator);function bn(){return CE}const Ig=new Lt(W.comparator);function $s(...n){let t=Ig;for(const e of n)t=t.insert(e.key,e);return t}function Sg(n){let t=Ig;return n.forEach(((e,i)=>t=t.insert(e,i.overlayedDocument))),t}function di(){return Xs()}function xg(){return Xs()}function Xs(){return new Pi((n=>n.toString()),((n,t)=>n.isEqual(t)))}const DE=new Lt(W.comparator),ME=new Qt(W.comparator);function ut(...n){let t=ME;for(const e of n)t=t.add(e);return t}const OE=new Qt(ct);function LE(){return OE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ss{constructor(t){this.sr=t}next(){return this.sr+=2,this.sr}static _r(){return new ss(0)}static ar(){return new ss(-1)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tw{constructor(){this.changes=new Pi((t=>t.toString()),((t,e)=>t.isEqual(e))),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,ce.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const i=this.changes.get(e);return i!==void 0?V.resolve(i):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sw{constructor(t,e,i,s){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=i,this.indexManager=s}getDocument(t,e){let i=null;return this.documentOverlayCache.getOverlay(t,e).next((s=>(i=s,this.remoteDocumentCache.getEntry(t,e)))).next((s=>(i!==null&&Js(i.mutation,s,Le.empty(),Ct.now()),s)))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next((i=>this.getLocalViewOfDocuments(t,i,ut()).next((()=>i))))}getLocalViewOfDocuments(t,e,i=ut()){const s=di();return this.populateOverlays(t,s,e).next((()=>this.computeViews(t,e,s,i).next((r=>{let o=$s();return r.forEach(((a,l)=>{o=o.insert(a,l.overlayedDocument)})),o}))))}getOverlayedDocuments(t,e){const i=di();return this.populateOverlays(t,i,e).next((()=>this.computeViews(t,e,i,ut())))}populateOverlays(t,e,i){const s=[];return i.forEach((r=>{e.has(r)||s.push(r)})),this.documentOverlayCache.getOverlays(t,s).next((r=>{r.forEach(((o,a)=>{e.set(o,a)}))}))}computeViews(t,e,i,s){let r=bn();const o=Xs(),a=(function(){return Xs()})();return e.forEach(((l,u)=>{const h=i.get(u.key);s.has(u.key)&&(h===void 0||h.mutation instanceof ki)?r=r.insert(u.key,u):h!==void 0?(o.set(u.key,h.mutation.getFieldMask()),Js(h.mutation,u,h.mutation.getFieldMask(),Ct.now())):o.set(u.key,Le.empty())})),this.recalculateAndSaveOverlays(t,r).next((l=>(l.forEach(((u,h)=>o.set(u,h))),e.forEach(((u,h)=>a.set(u,new Iw(h,o.get(u)??null)))),a)))}recalculateAndSaveOverlays(t,e){const i=Xs();let s=new Lt(((o,a)=>o-a)),r=ut();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next((o=>{for(const a of o)a.keys().forEach((l=>{const u=e.get(l);if(u===null)return;let h=i.get(l)||Le.empty();h=a.applyToLocalView(u,h),i.set(l,h);const d=(s.get(a.batchId)||ut()).add(l);s=s.insert(a.batchId,d)}))})).next((()=>{const o=[],a=s.getReverseIterator();for(;a.hasNext();){const l=a.getNext(),u=l.key,h=l.value,d=xg();h.forEach((p=>{if(!r.has(p)){const y=Dg(e.get(p),i.get(p));y!==null&&d.set(p,y),r=r.add(p)}})),o.push(this.documentOverlayCache.saveOverlays(t,u,d))}return V.waitFor(o)})).next((()=>i))}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next((i=>this.recalculateAndSaveOverlays(t,i)))}getDocumentsMatchingQuery(t,e,i,s){return xE(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):AE(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,i,s):this.getDocumentsMatchingCollectionQuery(t,e,i,s)}getNextDocuments(t,e,i,s){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,i,s).next((r=>{const o=s-r.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,i.largestBatchId,s-r.size):V.resolve(di());let a=lr,l=r;return o.next((u=>V.forEach(u,((h,d)=>(a<d.largestBatchId&&(a=d.largestBatchId),r.get(h)?V.resolve():this.remoteDocumentCache.getEntry(t,h).next((p=>{l=l.insert(h,p)}))))).next((()=>this.populateOverlays(t,u,r))).next((()=>this.computeViews(t,l,u,ut()))).next((h=>({batchId:a,changes:Sg(h)})))))}))}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new W(e)).next((i=>{let s=$s();return i.isFoundDocument()&&(s=s.insert(i.key,i)),s}))}getDocumentsMatchingCollectionGroupQuery(t,e,i,s){const r=e.collectionGroup;let o=$s();return this.indexManager.getCollectionParents(t,r).next((a=>V.forEach(a,(l=>{const u=(function(d,p){return new ba(p,null,d.explicitOrderBy.slice(),d.filters.slice(),d.limit,d.limitType,d.startAt,d.endAt)})(e,l.child(r));return this.getDocumentsMatchingCollectionQuery(t,u,i,s).next((h=>{h.forEach(((d,p)=>{o=o.insert(d,p)}))}))})).next((()=>o))))}getDocumentsMatchingCollectionQuery(t,e,i,s){let r;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,i.largestBatchId).next((o=>(r=o,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,i,r,s)))).next((o=>{r.forEach(((l,u)=>{const h=u.getKey();o.get(h)===null&&(o=o.insert(h,ce.newInvalidDocument(h)))}));let a=$s();return o.forEach(((l,u)=>{const h=r.get(l);h!==void 0&&Js(h.mutation,u,Le.empty(),Ct.now()),Ea(e,u)&&(a=a.insert(l,u))})),a}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lw{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=(function(){return vy()?8:rE(he())>0?6:4})()}initialize(t,e){this.fs=t,this.indexManager=e,this.Rs=!0}getDocumentsMatchingQuery(t,e,i,s){const r={result:null};return this.gs(t,e).next((o=>{r.result=o})).next((()=>{if(!r.result)return this.ps(t,e,s,i).next((o=>{r.result=o}))})).next((()=>{if(r.result)return;const o=new Ow;return this.ys(t,e,o).next((a=>{if(r.result=a,this.As)return this.ws(t,e,o,a.size)}))})).next((()=>r.result))}ws(t,e,i,s){return i.documentReadCount<this.Vs?($i()<=lt.DEBUG&&$("QueryEngine","SDK will not create cache indexes for query:",Ui(e),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),V.resolve()):($i()<=lt.DEBUG&&$("QueryEngine","Query:",Ui(e),"scans",i.documentReadCount,"local documents and returns",s,"documents as results."),i.documentReadCount>this.ds*s?($i()<=lt.DEBUG&&$("QueryEngine","The SDK decides to create cache indexes for query:",Ui(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,qe(e))):V.resolve())}gs(t,e){if(ed(e))return V.resolve(null);let i=qe(e);return this.indexManager.getIndexType(t,i).next((s=>s===0?null:(e.limit!==null&&s===1&&(e=Bl(e,null,"F"),i=qe(e)),this.indexManager.getDocumentsMatchingTarget(t,i).next((r=>{const o=ut(...r);return this.fs.getDocuments(t,o).next((a=>this.indexManager.getMinOffset(t,i).next((l=>{const u=this.bs(e,a);return this.Ss(e,u,o,l.readTime)?this.gs(t,Bl(e,null,"F")):this.Ds(t,u,e,l)}))))})))))}ps(t,e,i,s){return ed(e)||s.isEqual(J.min())?V.resolve(null):this.fs.getDocuments(t,i).next((r=>{const o=this.bs(e,r);return this.Ss(e,o,i,s)?V.resolve(null):($i()<=lt.DEBUG&&$("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Ui(e)),this.Ds(t,o,e,tE(s,lr)).next((a=>a)))}))}bs(t,e){let i=new Qt(Tg(t));return e.forEach(((s,r)=>{Ea(t,r)&&(i=i.add(r))})),i}Ss(t,e,i,s){if(t.limit===null)return!1;if(i.size!==e.size)return!0;const r=t.limitType==="F"?e.last():e.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(s)>0)}ys(t,e,i){return $i()<=lt.DEBUG&&$("QueryEngine","Using full collection scan to execute query:",Ui(e)),this.fs.getDocumentsMatchingQuery(t,e,Kn.min(),i)}Ds(t,e,i,s){return this.fs.getDocumentsMatchingQuery(t,i,s).next((r=>(e.forEach((o=>{r=r.insert(o.key,o)})),r)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qw(n){return new Gi(n)}function cl(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ti="RemoteStore";class iT{constructor(t,e,i,s,r){this.localStore=t,this.datastore=e,this.asyncQueue=i,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.Ra=[],this.Aa=r,this.Aa.Mo((o=>{i.enqueueAndForget((async()=>{Ri(this)&&($(Ti,"Restarting streams for network reachability change."),await(async function(l){const u=Z(l);u.Ea.add(4),await Cr(u),u.Va.set("Unknown"),u.Ea.delete(4),await xa(u)})(this))}))})),this.Va=new nT(i,s)}}async function xa(n){if(Ri(n))for(const t of n.Ra)await t(!0)}async function Cr(n){for(const t of n.Ra)await t(!1)}function Jg(n,t){const e=Z(n);e.Ia.has(t.targetId)||(e.Ia.set(t.targetId,t),jc(e)?Bc(e):gs(e).O_()&&zc(e,t))}function Uc(n,t){const e=Z(n),i=gs(e);e.Ia.delete(t),i.O_()&&Zg(e,t),e.Ia.size===0&&(i.O_()?i.L_():Ri(e)&&e.Va.set("Unknown"))}function zc(n,t){if(n.da.$e(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(J.min())>0){const e=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}gs(n).Z_(t)}function Zg(n,t){n.da.$e(t),gs(n).X_(t)}function Bc(n){n.da=new QE({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),At:t=>n.Ia.get(t)||null,ht:()=>n.datastore.serializer.databaseId}),gs(n).start(),n.Va.ua()}function jc(n){return Ri(n)&&!gs(n).x_()&&n.Ia.size>0}function Ri(n){return Z(n).Ea.size===0}function tm(n){n.da=void 0}async function sT(n){n.Va.set("Online")}async function rT(n){n.Ia.forEach(((t,e)=>{zc(n,t)}))}async function oT(n,t){tm(n),jc(n)?(n.Va.ha(t),Bc(n)):n.Va.set("Unknown")}async function aT(n,t,e){if(n.Va.set("Online"),t instanceof Ng&&t.state===2&&t.cause)try{await(async function(s,r){const o=r.cause;for(const a of r.targetIds)s.Ia.has(a)&&(await s.remoteSyncer.rejectListen(a,o),s.Ia.delete(a),s.da.removeTarget(a))})(n,t)}catch(i){$(Ti,"Failed to remove targets %s: %s ",t.targetIds.join(","),i),await Xo(n,i)}else if(t instanceof Io?n.da.Xe(t):t instanceof Vg?n.da.st(t):n.da.tt(t),!e.isEqual(J.min()))try{const i=await Yg(n.localStore);e.compareTo(i)>=0&&await(function(r,o){const a=r.da.Tt(o);return a.targetChanges.forEach(((l,u)=>{if(l.resumeToken.approximateByteSize()>0){const h=r.Ia.get(u);h&&r.Ia.set(u,h.withResumeToken(l.resumeToken,o))}})),a.targetMismatches.forEach(((l,u)=>{const h=r.Ia.get(l);if(!h)return;r.Ia.set(l,h.withResumeToken(se.EMPTY_BYTE_STRING,h.snapshotVersion)),Zg(r,l);const d=new Mn(h.target,l,u,h.sequenceNumber);zc(r,d)})),r.remoteSyncer.applyRemoteEvent(a)})(n,e)}catch(i){$(Ti,"Failed to raise snapshot:",i),await Xo(n,i)}}async function Xo(n,t,e){if(!ps(t))throw t;n.Ea.add(1),await Cr(n),n.Va.set("Offline"),e||(e=()=>Yg(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{$(Ti,"Retrying IndexedDB access"),await e(),n.Ea.delete(1),await xa(n)}))}function em(n,t){return t().catch((e=>Xo(n,e,t)))}async function Aa(n){const t=Z(n),e=Xn(t);let i=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:xc;for(;lT(t);)try{const s=await Bw(t.localStore,i);if(s===null){t.Ta.length===0&&e.L_();break}i=s.batchId,cT(t,s)}catch(s){await Xo(t,s)}nm(t)&&im(t)}function lT(n){return Ri(n)&&n.Ta.length<10}function cT(n,t){n.Ta.push(t);const e=Xn(n);e.O_()&&e.Y_&&e.ea(t.mutations)}function nm(n){return Ri(n)&&!Xn(n).x_()&&n.Ta.length>0}function im(n){Xn(n).start()}async function uT(n){Xn(n).ra()}async function hT(n){const t=Xn(n);for(const e of n.Ta)t.ea(e.mutations)}async function dT(n,t,e){const i=n.Ta.shift(),s=Mc.from(i,t,e);await em(n,(()=>n.remoteSyncer.applySuccessfulWrite(s))),await Aa(n)}async function fT(n,t){t&&Xn(n).Y_&&await(async function(i,s){if((function(o){return KE(o)&&o!==N.ABORTED})(s.code)){const r=i.Ta.shift();Xn(i).B_(),await em(i,(()=>i.remoteSyncer.rejectFailedWrite(r.batchId,s))),await Aa(i)}})(n,t),nm(n)&&im(n)}async function bd(n,t){const e=Z(n);e.asyncQueue.verifyOperationInProgress(),$(Ti,"RemoteStore received new credentials");const i=Ri(e);e.Ea.add(3),await Cr(e),i&&e.Va.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ea.delete(3),await xa(e)}async function pT(n,t){const e=Z(n);t?(e.Ea.delete(2),await xa(e)):t||(e.Ea.add(2),await Cr(e),e.Va.set("Unknown"))}function gs(n){return n.ma||(n.ma=(function(e,i,s){const r=Z(e);return r.sa(),new Xw(i,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)})(n.datastore,n.asyncQueue,{Zo:sT.bind(null,n),Yo:rT.bind(null,n),t_:oT.bind(null,n),J_:aT.bind(null,n)}),n.Ra.push((async t=>{t?(n.ma.B_(),jc(n)?Bc(n):n.Va.set("Unknown")):(await n.ma.stop(),tm(n))}))),n.ma}function Xn(n){return n.fa||(n.fa=(function(e,i,s){const r=Z(e);return r.sa(),new Jw(i,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),Yo:uT.bind(null,n),t_:fT.bind(null,n),ta:hT.bind(null,n),na:dT.bind(null,n)}),n.Ra.push((async t=>{t?(n.fa.B_(),await Aa(n)):(await n.fa.stop(),n.Ta.length>0&&($(Ti,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{static emptySet(t){return new Yi(t.comparator)}constructor(t){this.comparator=t?(e,i)=>t(e,i)||W.comparator(e.key,i.key):(e,i)=>W.comparator(e.key,i.key),this.keyedMap=$s(),this.sortedSet=new Lt(this.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal(((e,i)=>(t(e),!1)))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof Yi)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),i=t.sortedSet.getIterator();for(;e.hasNext();){const s=e.getNext().key,r=i.getNext().key;if(!s.isEqual(r))return!1}return!0}toString(){const t=[];return this.forEach((e=>{t.push(e.toString())})),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vd{constructor(){this.ga=new Lt(W.comparator)}track(t){const e=t.doc.key,i=this.ga.get(e);i?t.type!==0&&i.type===3?this.ga=this.ga.insert(e,t):t.type===3&&i.type!==1?this.ga=this.ga.insert(e,{type:i.type,doc:t.doc}):t.type===2&&i.type===2?this.ga=this.ga.insert(e,{type:2,doc:t.doc}):t.type===2&&i.type===0?this.ga=this.ga.insert(e,{type:0,doc:t.doc}):t.type===1&&i.type===0?this.ga=this.ga.remove(e):t.type===1&&i.type===2?this.ga=this.ga.insert(e,{type:1,doc:i.doc}):t.type===0&&i.type===1?this.ga=this.ga.insert(e,{type:2,doc:t.doc}):K(63341,{Vt:t,pa:i}):this.ga=this.ga.insert(e,t)}ya(){const t=[];return this.ga.inorderTraversal(((e,i)=>{t.push(i)})),t}}class rs{constructor(t,e,i,s,r,o,a,l,u){this.query=t,this.docs=e,this.oldDocs=i,this.docChanges=s,this.mutatedKeys=r,this.fromCache=o,this.syncStateChanged=a,this.excludesMetadataChanges=l,this.hasCachedResults=u}static fromInitialDocuments(t,e,i,s,r){const o=[];return e.forEach((a=>{o.push({type:0,doc:a})})),new rs(t,e,Yi.emptySet(e),o,i,s,!0,!1,r)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(t){if(!(this.fromCache===t.fromCache&&this.hasCachedResults===t.hasCachedResults&&this.syncStateChanged===t.syncStateChanged&&this.mutatedKeys.isEqual(t.mutatedKeys)&&va(this.query,t.query)&&this.docs.isEqual(t.docs)&&this.oldDocs.isEqual(t.oldDocs)))return!1;const e=this.docChanges,i=t.docChanges;if(e.length!==i.length)return!1;for(let s=0;s<e.length;s++)if(e[s].type!==i[s].type||!e[s].doc.isEqual(i[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aI{convertValue(t,e="none"){switch(Qn(t)){case 0:return null;case 1:return t.booleanValue;case 2:return zt(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(Yn(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw K(62114,{value:t})}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const i={};return Ai(t,((s,r)=>{i[s]=this.convertValue(r,e)})),i}convertVectorValue(t){var i,s,r;const e=(r=(s=(i=t.fields)==null?void 0:i[Ho].arrayValue)==null?void 0:s.values)==null?void 0:r.map((o=>zt(o.doubleValue)));return new Ne(e)}convertGeoPoint(t){return new Ge(zt(t.latitude),zt(t.longitude))}convertArray(t,e){return(t.values||[]).map((i=>this.convertValue(i,e)))}convertServerTimestamp(t,e){switch(e){case"previous":const i=ya(t);return i==null?null:this.convertValue(i,e);case"estimate":return this.convertTimestamp(cr(t));default:return null}}convertTimestamp(t){const e=Gn(t);return new Ct(e.seconds,e.nanos)}convertDocumentKey(t,e){const i=Mt.fromString(t);vt(Hg(i),9688,{name:t});const s=new ur(i.get(1),i.get(3)),r=new W(i.popFirst(5));return s.isEqual(e)||yn(`Document ${r} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),r}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,'"',u.BYTE_ORDER_MARK],u.WORKERS_SUPPORTED=!r&&!!i.Worker,u.NODE_STREAM_INPUT=1,u.LocalChunkSize=10485760,u.RemoteChunkSize=5242880,u.DefaultDelimiter=",",u.Parser=P,u.ParserHandle=b,u.NetworkStreamer=d,u.FileStreamer=p,u.StringStreamer=y,u.ReadableStreamStreamer=S,i.jQuery&&((s=i.jQuery).fn.parse=function(g){var _=g.config||{},v=[];return this.each(function(x){if(!(s(this).prop("tagName").toUpperCase()==="INPUT"&&s(this).attr("type").toLowerCase()==="file"&&i.FileReader)||!this.files||this.files.length===0)return!0;for(var G=0;G<this.files.length;G++)v.push({file:this.files[G],inputElem:this,instanceConfig:s.extend({},_)})}),I(),this;function I(){if(v.length===0)E(g.complete)&&g.complete();else{var x,G,q,st,j=v[0];if(E(g.before)){var rt=g.before(j.file,j.inputElem);if(typeof rt=="object"){if(rt.action==="abort")return x="AbortError",G=j.file,q=j.inputElem,st=rt.reason,void(E(g.error)&&g.error({name:x},G,q,st));if(rt.action==="skip")return void A();typeof rt.config=="object"&&(j.instanceConfig=s.extend(j.instanceConfig,rt.config))}else if(rt==="skip")return void A()}var U=j.instanceConfig.complete;j.instanceConfig.complete=function(Pt){E(U)&&U(Pt,j.file,j.inputElem),A()},u.parse(j.file,j.instanceConfig)}}function A(){v.splice(0,1),I()}}),o&&(i.onmessage=function(g){g=g.data,u.WORKER_ID===void 0&&g&&(u.WORKER_ID=g.workerId),typeof g.input=="string"?i.postMessage({workerId:u.WORKER_ID,results:u.parse(g.input,g.config),finished:!0}):(i.File&&g.input instanceof File||g.input instanceof Object)&&(g=u.parse(g.input,g.config))&&i.postMessage({workerId:u.WORKER_ID,results:g,finished:!0})}),(d.prototype=Object.create(h.prototype)).constructor=d,(p.prototype=Object.create(h.prototype)).constructor=p,(y.prototype=Object.create(y.prototype)).constructor=y,(S.prototype=Object.create(h.prototype)).constructor=S,u})})(xo)),xo.exports}var OI=MI();const LI=CI(OI);function VI(n){return new Promise((t,e)=>{LI.parse(n,{header:!0,skipEmptyLines:!0,dynamicTyping:!1,complete(i){i.errors.length>0&&console.warn("CSV parse warnings:",i.errors);try{const s=i.data.filter(o=>o.time&&o.coin).map(o=>NI(o)),r=FI(s);t(r)}catch(s){e(s)}},error(i){e(i)}})})}function NI(n){const t=(n.dir||"").trim(),e=/long/i.test(t),i=/short/i.test(t),s=/open/i.test(t),r=/close/i.test(t);return{time:zI(n.time),coin:(n.coin||"").trim().toUpperCase(),direction:e?"Long":i?"Short":t,action:s?"Open":r?"Close":"Unknown",dirRaw:t,price:Te(n.px),size:Te(n.sz),notional:Te(n.ntl),fee:Te(n.fee),closedPnl:Te(n.closedPnl)}}function FI(n){n.sort((i,s)=>i.time.localeCompare(s.time));const t={},e=[];for(const i of n){const s=`${i.coin}_${i.direction}`;if(i.action==="Open")t[s]||(t[s]=[]),t[s].push(i);else if(i.action==="Close")if(t[s]&&t[s].length>0){const r=t[s].shift();e.push($I(r,i))}else e.push(hl(i,!0));else e.push(hl(i,i.closedPnl!==0))}for(const i of Object.values(t))for(const s of i)e.push(hl(s,!1));return e.sort((i,s)=>s.time.localeCompare(i.time)),e}function $I(n,t){return{id:Cm(n.time,n.coin,n.direction,n.price),time:n.time,exitTime:t.time,coin:n.coin,direction:n.direction,entryPrice:n.price,exitPrice:t.price,size:n.size,notional:n.notional,fee:n.fee+t.fee,closedPnl:t.closedPnl,status:"Completed",risk:0,strategy:"",notes:"",tags:[],images:[],mae:null,mfe:null,source:"csv"}}function hl(n,t){return{id:Cm(n.time,n.coin,n.direction,n.price),time:n.time,exitTime:t?n.time:null,coin:n.coin,direction:n.direction,entryPrice:t?0:n.price,exitPrice:t?n.price:null,size:n.size,notional:n.notional,fee:n.fee,closedPnl:n.closedPnl,status:t?"Completed":"Active",risk:0,strategy:"",notes:"",tags:[],images:[],mae:null,mfe:null,source:"csv"}}function On(n){if(!n||n.length===0)return{entryPrice:0,exitPrice:null,size:0,remainingSize:0,notional:0,fee:0,closedPnl:0,status:"Active"};const t=n.filter(p=>p.type==="entry"),e=n.filter(p=>p.type==="exit"),i=t.reduce((p,y)=>p+y.size,0),s=e.reduce((p,y)=>p+y.size,0),r=Math.max(0,+(i-s).toFixed(8)),o=i>0?t.reduce((p,y)=>p+y.price*y.size,0)/i:0,a=s>0?e.reduce((p,y)=>p+y.price*y.size,0)/s:null,l=n.reduce((p,y)=>p+(y.fee||0),0),u=t.reduce((p,y)=>p+y.price*y.size,0),h=e.reduce((p,y)=>p+(y.pnl||0),0),d=r>0?"Active":s>0?"Completed":"Active";return{entryPrice:o,exitPrice:a,size:i,remainingSize:r,notional:u,fee:l,closedPnl:h,status:d}}function ea(n,t){if(!n)return n;const e=n.filter(r=>r.type==="entry"),i=e.reduce((r,o)=>r+o.size,0),s=i>0?e.reduce((r,o)=>r+o.price*o.size,0)/i:0;return n.map(r=>{if(r.type!=="exit")return r;const o=t==="Long"?(r.price-s)*r.size-(r.fee||0):(s-r.price)*r.size-(r.fee||0);return{...r,pnl:o}})}function UI(n){const t=Te(n.entryPrice),e=n.exitPrice!=null&&n.exitPrice!==""&&Te(n.exitPrice)!==0?Te(n.exitPrice):null,i=Te(n.size),s=Te(n.fee),r=n.direction||"Long",o={strategy:n.strategy||"",risk:n.risk||0,notes:n.notes||"",tags:n.tags||[],images:n.images||[],mae:n.mae!=null?Te(n.mae):null,mfe:n.mfe!=null?Te(n.mfe):null},a=[];t>0&&i>0&&a.push({type:"entry",time:n.time||new Date().toISOString(),price:t,size:i,fee:e?0:s,...o}),e&&i>0&&a.push({type:"exit",time:n.exitTime||n.time||new Date().toISOString(),price:e,size:i,fee:s,pnl:r==="Long"?(e-t)*i-s:(t-e)*i-s,...o});const l=On(a);return{id:"manual_"+Date.now()+"_"+Math.random().toString(36).slice(2,8),time:n.time||new Date().toISOString(),exitTime:e?n.exitTime||n.time||new Date().toISOString():null,coin:(n.coin||"").toUpperCase(),direction:r,legs:a,...l,closedPnl:Te(n.closedPnl)||l.closedPnl,risk:0,strategy:"",notes:"",tags:[],images:[],mae:null,mfe:null,source:"manual"}}function Cm(n,t,e,i){const s=`${n}_${t}_${e}_${i}`;let r=0;for(let o=0;o<s.length;o++){const a=s.charCodeAt(o);r=(r<<5)-r+a,r=r&r}return"hl_"+Math.abs(r).toString(36)}function zI(n){if(!n)return new Date().toISOString();const t=new Date(n.trim());return isNaN(t.getTime())?new Date().toISOString():t.toISOString()}function Te(n){if(n==null||n==="")return 0;const t=parseFloat(String(n).replace(/,/g,""));return isNaN(t)?0:t}function BI(n,t){const e=new Set(n.map(s=>s.id)),i=t.filter(s=>!e.has(s.id));return[...n,...i]}function jI(n){return n.map(t=>{if(t.entryPrice===void 0&&t.price!==void 0&&(t={...t,entryPrice:t.action==="Open"?t.price:0,exitPrice:t.action==="Close"?t.price:null,exitTime:t.action==="Close"?t.time:null,status:t.action==="Close"||t.closedPnl!==0?"Completed":"Active"}),!t.legs){const e={strategy:t.strategy||"",risk:t.risk||0,notes:t.notes||"",tags:t.tags||[],images:t.images||[]},i=[];t.entryPrice&&t.size&&i.push({type:"entry",time:t.time,price:t.entryPrice,size:t.size,fee:t.exitPrice?0:t.fee||0,...e}),t.exitPrice&&t.size&&i.push({type:"exit",time:t.exitTime||t.time,price:t.exitPrice,size:t.size,fee:t.fee||0,pnl:t.closedPnl||0,...e}),t={...t,legs:i};const s=On(i);t.remainingSize=s.remainingSize,t.status=s.status}return t})}function HI(n){const t={};n.forEach(i=>{const s=`${i.coin}_${i.direction}`;t[s]||(t[s]=[]),t[s].push(i)});const e=[];for(const[i,s]of Object.entries(t)){if(s.length<=1){e.push(s[0]);continue}s.sort((u,h)=>u.time.localeCompare(h.time));const r=s[0],o=[];for(const u of s)if(u.legs&&u.legs.length>0)for(const h of u.legs)o.push({...h,strategy:h.strategy||u.strategy||"",risk:h.risk!=null?h.risk:u.risk||0,notes:h.notes||u.notes||"",tags:h.tags||u.tags||[],images:h.images||u.images||[]});o.sort((u,h)=>(u.time||"").localeCompare(h.time||""));const a=ea(o,r.direction),l=On(a);e.push({...r,legs:a,...l,exitTime:l.status==="Completed"?s.at(-1).exitTime||s.at(-1).time:null,strategy:s.map(u=>u.strategy).filter(Boolean)[0]||"",risk:Math.max(...s.map(u=>u.risk||0)),notes:"",tags:[...new Set(s.flatMap(u=>u.tags||[]))],images:[...new Set(s.flatMap(u=>u.images||[]))],mae:null,mfe:null})}return e}function Dm(n){const t=n.filter(C=>C.closedPnl!==0||C.action==="Close"),e=t.filter(C=>C.closedPnl>0),i=t.filter(C=>C.closedPnl<0),s=t.reduce((C,R)=>C+R.closedPnl,0),r=n.reduce((C,R)=>C+Math.abs(R.fee),0),o=s-r,a=e.length?e.reduce((C,R)=>C+R.closedPnl,0)/e.length:0,l=i.length?Math.abs(i.reduce((C,R)=>C+R.closedPnl,0)/i.length):0,u=e.reduce((C,R)=>C+R.closedPnl,0),h=Math.abs(i.reduce((C,R)=>C+R.closedPnl,0)),d=h>0?u/h:u>0?1/0:0,p=t.length?Math.max(...t.map(C=>C.closedPnl)):0,y=t.length?Math.min(...t.map(C=>C.closedPnl)):0,S=t.length?e.length/t.length*100:0,b=t.filter(C=>C.mae!=null&&C.mae!==0),T=t.filter(C=>C.mfe!=null&&C.mfe!==0),P=b.length?b.reduce((C,R)=>C+R.mae,0)/b.length:null,k=T.length?T.reduce((C,R)=>C+R.mfe,0)/T.length:null;return{totalTrades:n.length,closingTrades:t.length,wins:e.length,losses:i.length,totalPnl:s,totalFees:r,netPnl:o,winRate:S,avgWin:a,avgLoss:l,profitFactor:d,bestTrade:p,worstTrade:y,avgMae:P,avgMfe:k}}function iu(n,t){const e={};n.forEach(s=>{const r=t(s);r&&(e[r]||(e[r]=[]),e[r].push(s))});const i={};for(const[s,r]of Object.entries(e))i[s]=Dm(r);return i}function WI(n){return iu(n,t=>t.coin)}function qI(n){return iu(n,t=>t.strategy||null)}function KI(n){return iu(n,t=>t.risk>0?`Risk ${t.risk}`:null)}function su(n){const t=n.filter(i=>i.closedPnl!==0||i.action==="Close"),e={};return t.forEach(i=>{const s=i.time.slice(0,10);e[s]||(e[s]={date:s,pnl:0,trades:0,fees:0}),e[s].pnl+=i.closedPnl,e[s].trades+=1,e[s].fees+=Math.abs(i.fee)}),Object.values(e).sort((i,s)=>i.date.localeCompare(s.date))}function GI(n){const t=su(n);let e=0;return t.map(i=>(e+=i.pnl,{date:i.date,equity:e}))}function YI(n){const t=n.filter(i=>i.closedPnl!==0||i.action==="Close"),e={};return t.forEach(i=>{e[i.coin]||(e[i.coin]=0),e[i.coin]+=i.closedPnl}),Object.entries(e).map(([i,s])=>({coin:i,pnl:s})).sort((i,s)=>s.pnl-i.pnl)}function QI(n){const t=n.filter(i=>i.strategy&&(i.closedPnl!==0||i.action==="Close")),e={};return t.forEach(i=>{e[i.strategy]||(e[i.strategy]=0),e[i.strategy]+=i.closedPnl}),Object.entries(e).map(([i,s])=>({strategy:i,pnl:s})).sort((i,s)=>s.pnl-i.pnl)}function XI(n){return n.filter(t=>t.mae!=null&&t.mfe!=null&&(t.mae!==0||t.mfe!==0)).map(t=>({mae:t.mae,mfe:t.mfe,pnl:t.closedPnl,coin:t.coin,isWin:t.closedPnl>0}))}function JI(n){const t=su(n),e={};return t.forEach(i=>{e[i.date]=i}),e}function $t(n){return n==null?"-":(n>0?"+":n<0?"-":"")+"$"+Math.abs(n).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Hi(n){return n==null?"-":n.toFixed(1)+"%"}function ZI(n){if(!n)return"-";const t=new Date(n);return t.toLocaleDateString("en-US",{day:"2-digit",month:"2-digit",year:"numeric"})+" "+t.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}function tS(n,t){const e=Dm(n);t.innerHTML=`
  ...
  `}function nS(n,t){const e=t.filter(s=>s.status==="Active"),i=e.reduce((s,r)=>{const o=r.remainingSize!=null?r.remainingSize:r.size;return s+(r.entryPrice||0)*o},0);return`
    <div class="kpi-grid">
      ...
      ${nn("Win Rate",Hi(n.winRate),n.winRate>=50?"profit":"loss",`${n.wins}W / ${n.losses}L`,"stagger-4")}
  ...
  `}const dl=25;let Ae=1,mr="time",Qi="desc",Ft={coin:"",direction:"",strategy:"",dateFrom:"",dateTo:""};function Ca(n,t,e){const i=Mr(),s=[...new Set(n.map(u=>u.coin))].sort(),r=rS(n),o=oS(r),a=Math.max(1,Math.ceil(o.length/dl));Ae>a&&(Ae=a);const l=o.slice((Ae-1)*dl,Ae*dl);t.innerHTML=`
    <div class="page-header">
      <div>
    ...
    ${sS(Ae,a,r.length)}
  `,aS(t,n,e),lS(t,n,e),cS(t,n,e),uS(t,n,e),hS(t,l)}function sn(n,t){const e=mr===n;return`<th data-sort="${n}" class="${e?"sorted":""}">${t} <span class="sort-indicator">${e?Qi==="asc"?"↑":"↓":"↕"}</span></th>`}function iS(n){const t=n.closedPnl>0?"cell-profit":n.closedPnl<0?"cell-loss":"",e=n.direction==="Long"?"long":n.direction==="Short"?"short":"",i=n.status==="Active",s=n.entryPrice||0,r=n.exitPrice;return(n.legs||[]).length,`
  ...
  `,n.classList.remove("hidden");let r=0,o=[],a=[];t.querySelector("#trade-img-upload").addEventListener("change",P=>{const k=t.querySelector("#trade-img-gallery");Array.from(P.target.files).forEach(C=>{const R=new FileReader;R.onload=M=>{const L="img_"+Date.now()+"_"+Math.random().toString(36).slice(2,6);a.push({id:L,dataUrl:M.target.result});const E=document.createElement("img");E.src=M.target.result,E.style.cssText="width:48px;height:48px;object-fit:cover;border-radius:4px;border:1px solid var(--border-subtle);",k.appendChild(E)},R.readAsDataURL(C)})});const l=()=>{n.classList.add("hidden")};t.querySelector("#modal-close").addEventListener("click",l),t.querySelector("#modal-cancel").addEventListener("click",l),n.addEventListener("click",P=>{P.target===n&&l()});const u=t.querySelector("#trade-entry-price"),h=t.querySelector("#trade-exit-price"),d=t.querySelector("#trade-size"),p=t.querySelector("#trade-notional"),y=t.querySelector("#trade-fee"),S=t.querySelector("#trade-direction"),b=t.querySelector("#trade-pnl");function T(){const P=parseFloat(u.value)||0,k=parseFloat(h.value)||0,C=parseFloat(d.value)||0,R=parseFloat(y.value)||0;if(P&&C&&!p.value&&(p.placeholder=(P*C).toFixed(2)),P>0&&k>0&&C>0){const L=S.value==="Long"?(k-P)*C:(P-k)*C;b.value=(L-R).toFixed(2)}}u.addEventListener("input",T),h.addEventListener("input",T),d.addEventListener("input",T),y.addEventListener("input",T),S.addEventListener("change",T),t.querySelectorAll(".risk-star-btn").forEach(P=>{P.addEventListener("click",()=>{r=parseInt(P.dataset.risk),t.querySelectorAll(".risk-star-btn").forEach(k=>{k.style.color=parseInt(k.dataset.risk)<=r?"#f59e0b":"#374151"})})}),t.querySelectorAll(".tag-toggle-btn").forEach(P=>{P.addEventListener("click",()=>{const k=P.dataset.tag;o.includes(k)?(o=o.filter(C=>C!==k),P.style.background="transparent",P.style.color="var(--text-secondary)",P.style.borderColor="var(--border-medium)"):(o.push(k),P.style.background="var(--accent-glow)",P.style.color="var(--accent-primary)",P.style.borderColor="var(--accent-primary)")})}),t.querySelector("#modal-save").addEventListener("click",async()=>{const P=t.querySelector("#trade-coin").value.trim();if(!P){alert("Please fill in the coin!");return}for(const R of a)await ta(R.id,R.dataUrl);const k=t.querySelector("#trade-time").value,C=UI({time:k?new Date(k).toISOString():new Date().toISOString(),coin:P,direction:t.querySelector("#trade-direction").value,entryPrice:t.querySelector("#trade-entry-price").value,exitPrice:t.querySelector("#trade-exit-price").value||null,size:t.querySelector("#trade-size").value,notional:t.querySelector("#trade-notional").value,fee:t.querySelector("#trade-fee").value,closedPnl:t.querySelector("#trade-pnl").value,risk:r,strategy:t.querySelector("#trade-strategy").value,notes:t.querySelector("#trade-notes").value,tags:o,images:a.map(R=>R.id),mae:t.querySelector("#trade-mae").value||null,mfe:t.querySelector("#trade-mfe").value||null});e(C),l()})}function fS(){const n=new Date,t=n.getTimezoneOffset();return new Date(n.getTime()-t*60*1e3).toISOString().slice(0,16)}function Vd(n){const t=new Date(n);return t.toLocaleDateString("en-US",{day:"2-digit",month:"2-digit",year:"numeric"})+" "+t.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}function Vi(n){return n!=null?"$"+n.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}function Nd(n){const t=new Date(n),e=t.getTimezoneOffset();return new Date(t.getTime()-e*60*1e3).toISOString().slice(0,16)}function pS(n,t,e,i,s){let r=JSON.parse(JSON.stringify(n.legs||[]));const o=Mr();function a(){const b=On(r),T=r.filter(k=>k.type==="entry"),P=r.filter(k=>k.type==="exit");t.innerHTML=`
    ...
    <div class="kpi-grid" style="margin-bottom:1.5rem;">
      <div class="kpi-card animate-in stagger-1">
        ...
        <div class="kpi-value">${Vi(b.entryPrice)}</div>
      </div>
      <div class="kpi-card animate-in stagger-2">
        <div class="kpi-label">Avg Exit</div>
        <div class="kpi-value">${b.exitPrice?Vi(b.exitPrice):"—"}</div>
      </div>
      ...
      <div class="kpi-card animate-in stagger-5">
        ...
        <div class="kpi-value">${Vi(b.notional)}</div>
      </div>
...
`):n}function Rk(n,t){const{element:e,datasetIndex:i,index:s}=t,r=n.getDatasetMeta(i).controller,{label:o,value:a}=r.getLabelAndValue(s);return{chart:n,label:o,parsed:r.getParsed(s),raw:n.data.datasets[i].data[s],formattedValue:a,dataset:r.getDataset(),dataIndex:s,datasetIndex:i,element:e}}function Hf(n,t){const e=n.chart.ctx,{body:i,footer:s,title:r}=n,{boxWidth:o,boxHeight:a}=t,l=_e(t.bodyFont),u=_e(t.titleFont),h=_e(t.footerFont),d=r.length,p=s.length,y=i.length,S=Fe(t.padding);let b=S.height,T=0,P=i.reduce((R,M)=>R+M.before.length+M.lines.length+M.after.length,0);if(P+=n.beforeBody.length+n.afterBody.length,d&&(b+=d*u.lineHeight+(d-1)*t.titleSpacing+t.titleMarginBottom),P){const R=t.displayColors?Math.max(a,l.lineHeight):l.lineHeight;b+=y*R+(P-y)*l.lineHeight+(P-1)*t.bodySpacing}p&&(b+=t.footerMarginTop+p*h.lineHeight+(p-1)*t.footerSpacing);let k=0;const C=function(R){T=Math.max(T,e.measureText(R).width+k)};return e.save(),e.font=u.string,wt(n.title,C),e.font=l.string,wt(n.beforeBody.concat(n.afterBody),C),k=t.displayColors?o+2+t.boxPadding:0,wt(i,R=>{wt(R.before,C),wt(R.lines,C),wt(R.after,C)}),k=0,e.font=h.string,wt(n.footer,C),e.restore(),T+=S.width,{width:T,height:b}}function Ck(n,t){const{y:e,height:i}=t;return e<i/2?"top":e>n.height-i/2?"bottom":"center"}function Dk(n,t,e,i){const{x:s,width:r}=i,o=e.caretSize+e.caretPadding;if(n==="left"&&s+r+o>t.width||n==="right"&&s-r-o<0)return!0}function Mk(n,t,e,i){const{x:s,width:r}=e,{width:o,chartArea:{left:a,right:l}}=n;let u="center";return i==="center"?u=s<=(a+l)/2?"left":"right":s<=r/2?u="left":s>=o-r/2&&(u="right"),Dk(u,n,t,e)&&(u="center"),u}function Wf(n,t,e){const i=e.yAlign||t.yAlign||Ck(n,e);return{xAlign:e.xAlign||t.xAlign||Mk(n,t,e,i),yAlign:i}}function Ok(n,t){let{x:e,width:i}=n;return t==="right"?e-=i:t==="center"&&(e-=i/2),e}function Lk(n,t,e){let{y:i,height:s}=n;return t==="top"?i+=e:t==="bottom"?i-=s+e:i-=s/2,i}function qf(n,t,e,i){const{caretSize:s,caretPadding:r,cornerRadius:o}=n,{xAlign:a,yAlign:l}=e,u=s+r,{topLeft:h,topRight:d,bottomLeft:p,bottomRight:y}=Xi(o);let S=Ok(t,a);const b=Lk(t,l,u);return l==="center"?a==="left"?S+=u:a==="right"&&(S-=u):a==="left"?S-=Math.max(h,p)+s:a==="right"&&(S+=Math.max(d,y)+s),{x:ue(S,0,i.width-t.width),y:ue(b,0,i.height-t.height)}}function fo(n,t,e){const i=Fe(e.padding);return t==="center"?n.x+n.width/2:t==="right"?n.x+n.width-i.right:n.x+i.left}function Kf(n){return Be([],an(n))}function Vk(n,t,e){return Ci(n,{tooltip:t,tooltipItems:e,type:"tooltip"})}function Gf(n,t){const e=t&&t.dataset&&t.dataset.tooltip&&t.dataset.tooltip.callbacks;return e?n.override(e):n}const S_={beforeTitle:rn,title(n){if(n.length>0){const t=n[0],e=t.chart.data.labels,i=e?e.length:0;if(this&&this.options&&this.options.mode==="dataset")return t.dataset.label||"";if(t.label)return t.label;if(i>0&&t.dataIndex<i)return e[t.dataIndex]}return""},afterTitle:rn,beforeBody:rn,beforeLabel:rn,label(n){if(this&&this.options&&this.options.mode==="dataset")return n.label+": "+n.formattedValue||n.formattedValue;let t=n.dataset.label||"";t&&(t+=": ");const e=n.formattedValue;return _t(e)||(t+=e),t},labelColor(n){const e=n.chart.getDatasetMeta(n.datasetIndex).controller.getStyle(n.dataIndex);return{borderColor:e.borderColor,backgroundColor:e.backgroundColor,borderWidth:e.borderWidth,borderDash:e.borderDash,borderDashOffset:e.borderDashOffset,borderRadius:0}},labelTextColor(){return this.options.bodyColor},labelPointStyle(n){const e=n.chart.getDatasetMeta(n.datasetIndex).controller.getStyle(n.dataIndex);return{pointStyle:e.pointStyle,rotation:e.rotation}},afterLabel:rn,afterBody:rn,beforeFooter:rn,footer:rn,afterFooter:rn};function pe(n,t,e,i){const s=n[t].call(e,i);return typeof s>"u"?S_[t].call(e,i):s}class ac extends tn{constructor(t){super(),this.opacity=0,this._active=[],this._eventPosition=void 0,this._size=void 0,this._cachedAnimations=void 0,this._tooltipItems=[],this.$animations=void 0,this.$context=void 0,this.chart=t.chart,this.options=t.options,this.dataPoints=void 0,this.title=void 0,this.beforeBody=void 0,this.body=void 0,this.afterBody=void 0,this.footer=void 0,this.xAlign=void 0,this.yAlign=void 0,this.x=void 0,this.y=void 0,this.height=void 0,this.width=void 0,this.caretX=void 0,this.caretY=void 0,this.labelColors=void 0,this.labelPointStyles=void 0,this.labelTextColors=void 0}initialize(t){this.options=t,this._cachedAnimations=void 0,this.$context=void 0}_resolveAnimations(){const t=this._cachedAnimations;if(t)return t;const e=this.chart,i=this.options.setContext(this.getContext()),s=i.enabled&&e.options.animation&&i.animations,r=new a_(this.chart,s);return s._cacheable&&(this._cachedAnimations=Object.freeze(r)),r}getContext(){return this.$context||(this.$context=Vk(this.chart.getContext(),this,this._tooltipItems))}getTitle(t,e){const{callbacks:i}=e,s=pe(i,"beforeTitle",this,t),r=pe(i,"title",this,t),o=pe(i,"afterTitle",this,t);let a=[];return a=Be(a,an(s)),a=Be(a,an(r)),a=Be(a,an(o)),a}getBeforeBody(t,e){return Kf(pe(e.callbacks,"beforeBody",this,t))}getBody(t,e){const{callbacks:i}=e,s=[];return wt(t,r=>{const o={before:[],lines:[],after:[]},a=Gf(i,r);Be(o.before,an(pe(a,"beforeLabel",this,r))),Be(o.lines,pe(a,"label",this,r)),Be(o.after,an(pe(a,"afterLabel",this,r))),s.push(o)}),s}getAfterBody(t,e){return Kf(pe(e.callbacks,"afterBody",this,t))}getFooter(t,e){const{callbacks:i}=e,s=pe(i,"beforeFooter",this,t),r=pe(i,"footer",this,t),o=pe(i,"afterFooter",this,t);let a=[];return a=Be(a,an(s)),a=Be(a,an(r)),a=Be(a,an(o)),a}_createItems(t){const e=this._active,i=this.chart.data,s=[],r=[],o=[];let a=[],l,u;for(l=0,u=e.length;l<u;++l)a.push(Rk(this.chart,e[l]));return t.filter&&(a=a.filter((h,d,p)=>t.filter(h,d,p,i))),t.itemSort&&(a=a.sort((h,d)=>t.itemSort(h,d,i))),wt(a,h=>{const d=Gf(t.callbacks,h);s.push(pe(d,"labelColor",this,h)),r.push(pe(d,"labelPointStyle",this,h)),o.push(pe(d,"labelTextColor",this,h))}),this.labelColors=s,this.labelPointStyles=r,this.labelTextColors=o,this.dataPoints=a,a}update(t,e){const i=this.options.setContext(this.getContext()),s=this._active;let r,o=[];if(!s.length)this.opacity!==0&&(r={opacity:0});else{const a=qs[i.position].call(this,s,this._eventPosition);o=this._createItems(i),this.title=this.getTitle(o,i),this.beforeBody=this.getBeforeBody(o,i),this.body=this.getBody(o,i),this.afterBody=this.getAfterBody(o,i),this.footer=this.getFooter(o,i);const l=this._size=Hf(this,i),u=Object.assign({},a,l),h=Wf(this.chart,i,u),d=qf(i,u,h,this.chart);this.xAlign=h.xAlign,this.yAlign=h.yAlign,r={opacity:1,x:d.x,y:d.y,width:l.width,height:l.height,caretX:a.x,caretY:a.y}}this._tooltipItems=o,this.$context=void 0,r&&this._resolveAnimations().update(this,r),t&&i.external&&i.external.call(this,{chart:this.chart,tooltip:this,replay:e})}drawCaret(t,e,i,s){const r=this.getCaretPosition(t,i,s);e.lineTo(r.x1,r.y1),e.lineTo(r.x2,r.y2),e.lineTo(r.x3,r.y3)}getCaretPosition(t,e,i){const{xAlign:s,yAlign:r}=this,{caretSize:o,cornerRadius:a}=i,{topLeft:l,topRight:u,bottomLeft:h,bottomRight:d}=Xi(a),{x:p,y}=t,{width:S,height:b}=e;let T,P,k,C,R,M;return r==="center"?(R=y+b/2,s==="left"?(T=p,P=T-o,C=R+o,M=R-o):(T=p+S,P=T+o,C=R-o,M=R+o),k=T):(s==="left"?P=p+Math.max(l,h)+o:s==="right"?P=p+S-Math.max(u,d)-o:P=this.caretX,r==="top"?(C=y,R=C-o,T=P-o,k=P+o):(C=y+b,R=C+o,T=P+o,k=P-o),M=C),{x1:T,x2:P,x3:k,y1:C,y2:R,y3:M}}drawTitle(t,e,i){const s=this.title,r=s.length;let o,a,l;if(r){const u=Ji(i.rtl,this.x,this.width);for(t.x=fo(this,i.titleAlign,i),e.textAlign=u.textAlign(i.titleAlign),e.textBaseline="middle",o=_e(i.titleFont),a=i.titleSpacing,e.fillStyle=i.titleColor,e.font=o.string,l=0;l<r;++l)e.fillText(s[l],u.x(t.x),t.y+o.lineHeight/2),t.y+=o.lineHeight+a,l+1===r&&(t.y+=i.titleMarginBottom-a)}}_drawColorBox(t,e,i,s,r){const o=this.labelColors[i],a=this.labelPointStyles[i],{boxHeight:l,boxWidth:u}=r,h=_e(r.bodyFont),d=fo(this,"left",r),p=s.x(d),y=l<h.lineHeight?(h.lineHeight-l)/2:0,S=e.y+y;if(r.usePointStyle){const b={radius:Math.min(u,l)/2,pointStyle:a.pointStyle,rotation:a.rotation,borderWidth:1},T=s.leftForLtr(p,u)+u/2,P=S+l/2;t.strokeStyle=r.multiKeyBackground,t.fillStyle=r.multiKeyBackground,nc(t,b,T,P),t.strokeStyle=o.borderColor,t.fillStyle=o.backgroundColor,nc(t,b,T,P)}else{t.lineWidth=ht(o.borderWidth)?Math.max(...Object.values(o.borderWidth)):o.borderWidth||1,t.strokeStyle=o.borderColor,t.setLineDash(o.borderDash||[]),t.lineDashOffset=o.borderDashOffset||0;const b=s.leftForLtr(p,u),T=s.leftForLtr(s.xPlus(p,1),u-2),P=Xi(o.borderRadius);Object.values(P).some(k=>k!==0)?(t.beginPath(),t.fillStyle=r.multiKeyBackground,oa(t,{x:b,y:S,w:u,h:l,radius:P}),t.fill(),t.stroke(),t.fillStyle=o.backgroundColor,t.beginPath(),oa(t,{x:T,y:S+1,w:u-2,h:l-2,radius:P}),t.fill()):(t.fillStyle=r.multiKeyBackground,t.fillRect(b,S,u,l),t.strokeRect(b,S,u,l),t.fillStyle=o.backgroundColor,t.fillRect(T,S+1,u-2,l-2))}t.fillStyle=this.labelTextColors[i]}drawBody(t,e,i){const{body:s}=this,{bodySpacing:r,bodyAlign:o,displayColors:a,boxHeight:l,boxWidth:u,boxPadding:h}=i,d=_e(i.bodyFont);let p=d.lineHeight,y=0;const S=Ji(i.rtl,this.x,this.width),b=function(g){e.fillText(g,S.x(t.x+y),t.y+p/2),t.y+=p+r},T=S.textAlign(o);let P,k,C,R,M,L,E;for(e.textAlign=o,e.textBaseline="middle",e.font=d.string,t.x=fo(this,T,i),e.fillStyle=i.bodyColor,wt(this.beforeBody,b),y=a&&T!=="right"?o==="center"?u/2+h:u+2+h:0,R=0,L=s.length;R<L;++R){for(P=s[R],k=this.labelTextColors[R],e.fillStyle=k,wt(P.before,b),C=P.lines,a&&C.length&&(this._drawColorBox(e,t,R,S,i),p=Math.max(d.lineHeight,l)),M=0,E=C.length;M<E;++M)b(C[M]),p=d.lineHeight;wt(P.after,b)}y=0,p=d.lineHeight,wt(this.afterBody,b),t.y-=r}drawFooter(t,e,i){const s=this.footer,r=s.length;let o,a;if(r){const l=Ji(i.rtl,this.x,this.width);for(t.x=fo(this,i.footerAlign,i),t.y+=i.footerMarginTop,e.textAlign=l.textAlign(i.footerAlign),e.textBaseline="middle",o=_e(i.footerFont),e.fillStyle=i.footerColor,e.font=o.string,a=0;a<r;++a)e.fillText(s[a],l.x(t.x),t.y+o.lineHeight/2),t.y+=o.lineHeight+i.footerSpacing}}drawBackground(t,e,i,s){const{xAlign:r,yAlign:o}=this,{x:a,y:l}=t,{width:u,height:h}=i,{topLeft:d,topRight:p,bottomLeft:y,bottomRight:S}=Xi(s.cornerRadius);e.fillStyle=s.backgroundColor,e.strokeStyle=s.borderColor,e.lineWidth=s.borderWidth,e.beginPath(),e.moveTo(a+d,l),o==="top"&&this.drawCaret(t,e,i,s),e.lineTo(a+u-p,l),e.quadraticCurveTo(a+u,l,a+u,l+p),o==="center"&&r==="right"&&this.drawCaret(t,e,i,s),e.lineTo(a+u,l+h-S),e.quadraticCurveTo(a+u,l+h,a+u-S,l+h),o==="bottom"&&this.drawCaret(t,e,i,s),e.lineTo(a+y,l+h),e.quadraticCurveTo(a,l+h,a,l+h-y),o==="center"&&r==="left"&&this.drawCaret(t,e,i,s),e.lineTo(a,l+d),e.quadraticCurveTo(a,l,a+d,l),e.closePath(),e.fill(),s.borderWidth>0&&e.stroke()}_updateAnimationTarget(t){const e=this.chart,i=this.$animations,s=i&&i.x,r=i&&i.y;if(s||r){const o=qs[t.position].call(this,this._active,this._eventPosition);if(!o)return;const a=this._size=Hf(this,t),l=Object.assign({},o,this._size),u=Wf(e,t,l),h=qf(t,l,u,e);(s._to!==h.x||r._to!==h.y)&&(this.xAlign=u.xAlign,this.yAlign=u.yAlign,this.width=a.width,this.height=a.height,this.caretX=o.x,this.caretY=o.y,this._resolveAnimations().update(this,h))}}_willRender(){return!!this.opacity}draw(t){const e=this.options.setContext(this.getContext());let i=this.opacity;if(!i)return;this._updateAnimationTarget(e);const s={width:this.width,height:this.height},r={x:this.x,y:this.y};i=Math.abs(i)<.001?0:i;const o=Fe(e.padding),a=this.title.length||this.beforeBody.length||this.body.length||this.afterBody.length||this.footer.length;e.enabled&&a&&(t.save(),t.globalAlpha=i,this.drawBackground(r,t,s,e),e_(t,e.textDirection),r.y+=o.top,this.drawTitle(r,t,e),this.drawBody(r,t,e),this.drawFooter(r,t,e),n_(t,e.textDirection),t.restore())}getActiveElements(){return this._active||[]}setActiveElements(t,e){const i=this._active,s=t.map(({datasetIndex:a,index:l})=>{const u=this.chart.getDatasetMeta(a);if(!u)throw new Error("Cannot find a dataset at index "+a);return{datasetIndex:a,element:u.data[l],index:l}}),r=!na(i,s),o=this._positionChanged(s,e);(r||o)&&(this._active=s,this._eventPosition=e,this._ignoreReplayEvents=!0,this.update(!0))}handleEvent(t,e,i=!0){if(e&&this._ignoreReplayEvents)return!1;this._ignoreReplayEvents=!1;const s=this.options,r=this._active||[],o=this._getActiveElements(t,r,e,i),a=this._positionChanged(o,t),l=e||!na(o,r)||a;return l&&(this._active=o,(s.enabled||s.external)&&(this._eventPosition={x:t.x,y:t.y},this.update(!0,e))),l}_getActiveElements(t,e,i,s){const r=this.options;if(t.type==="mouseout")return[];if(!s)return e.filter(a=>this.chart.data.datasets[a.datasetIndex]&&this.chart.getDatasetMeta(a.datasetIndex).controller.getParsed(a.index)!==void 0);const o=this.chart.getElementsAtEventForMode(t,r.mode,r,i);return r.reverse&&o.reverse(),o}_positionChanged(t,e){const{caretX:i,caretY:s,options:r}=this,o=qs[r.position].call(this,t,e);return o!==!1&&(i!==o.x||s!==o.y)}}z(ac,"positioners",qs);var Nk={id:"tooltip",_element:ac,positioners:qs,afterInit(n,t,e){e&&(n.tooltip=new ac({chart:n,options:e}))},beforeUpdate(n,t,e){n.tooltip&&n.tooltip.initialize(e)},reset(n,t,e){n.tooltip&&n.tooltip.initialize(e)},afterDraw(n){const t=n.tooltip;if(t&&t._willRender()){const e={tooltip:t};if(n.notifyPlugins("beforeTooltipDraw",{...e,cancelable:!0})===!1)return;t.draw(n.ctx),n.notifyPlugins("afterTooltipDraw",e)}},afterEvent(n,t){if(n.tooltip){const e=t.replay;n.tooltip.handleEvent(t.event,e,t.inChartArea)&&(t.changed=!0)}},defaults:{enabled:!0,external:null,position:"average",backgroundColor:"rgba(0,0,0,0.8)",titleColor:"#fff",titleFont:{weight:"bold"},titleSpacing:2,titleMarginBottom:6,titleAlign:"left",bodyColor:"#fff",bodySpacing:2,bodyFont:{},bodyAlign:"left",footerColor:"#fff",footerSpacing:2,footerMarginTop:6,footerFont:{weight:"bold"},footerAlign:"left",padding:6,caretPadding:2,caretSize:5,cornerRadius:6,boxHeight:(n,t)=>t.bodyFont.size,boxWidth:(n,t)=>t.bodyFont.size,multiKeyBackground:"#fff",displayColors:!0,boxPadding:0,borderColor:"rgba(0,0,0,0)",borderWidth:0,animation:{duration:400,easing:"easeOutQuart"},animations:{numbers:{type:"number",properties:["x","y","width","height","caretX","caretY"]},opacity:{easing:"linear",duration:200}},callbacks:S_},defaultRoutes:{bodyFont:"font",footerFont:"font",titleFont:"font"},descriptors:{_scriptable:n=>n!=="filter"&&n!=="itemSort"&&n!=="external",_indexable:!1,callbacks:{_scriptable:!1,_indexable:!1},animation:{_fallback:!1},animations:{_fallback:"animation"}},additionalOptionScopes:["interaction"]};const Fk=(n,t,e,i)=>(typeof t=="string"?(e=n.push(t)-1,i.unshift({index:e,label:t})):isNaN(t)&&(e=null),e);function $k(n,t,e,i){const s=n.indexOf(t);if(s===-1)return Fk(n,t,e,i);const r=n.lastIndexOf(t);return s!==r?e:s}const Uk=(n,t)=>n===null?null:ue(Math.round(n),0,t);function Yf(n){const t=this.getLabels();return n>=0&&n<t.length?t[n]:n}class lc extends ms{constructor(t){super(t),this._startValue=void 0,this._valueRange=0,this._addedLabels=[]}init(t){const e=this._addedLabels;if(e.length){const i=this.getLabels();for(const{index:s,label:r}of e)i[s]===r&&i.splice(s,1);this._addedLabels=[]}super.init(t)}parse(t,e){if(_t(t))return null;const i=this.getLabels();return e=isFinite(e)&&i[e]===t?e:$k(i,t,it(e,t),this._addedLabels),Uk(e,i.length-1)}determineDataLimits(){const{minDefined:t,maxDefined:e}=this.getUserBounds();let{min:i,max:s}=this.getMinMax(!0);this.options.bounds==="ticks"&&(t||(i=0),e||(s=this.getLabels().length-1)),this.min=i,this.max=s}buildTicks(){const t=this.min,e=this.max,i=this.options.offset,s=[];let r=this.getLabels();r=t===0&&e===r.length-1?r:r.slice(t,e+1),this._valueRange=Math.max(r.length-(i?0:1),1),this._startValue=this.min-(i?.5:0);for(let o=t;o<=e;o++)s.push({value:o});return s}getLabelForValue(t){return Yf.call(this,t)}configure(){super.configure(),this.isHorizontal()||(this._reversePixels=!this._reversePixels)}getPixelForValue(t){return typeof t!="number"&&(t=this.parse(t)),t===null?NaN:this.getPixelForDecimal((t-this._startValue)/this._valueRange)}getPixelForTick(t){const e=this.ticks;return t<0||t>e.length-1?null:this.getPixelForValue(e[t].value)}getValueForPixel(t){return Math.round(this._startValue+this.getDecimalForPixel(t)*this._valueRange)}getBasePixel(){return this.bottom}}z(lc,"id","category"),z(lc,"defaults",{ticks:{callback:Yf}});function zk(n,t){const e=[],{bounds:s,step:r,min:o,max:a,precision:l,count:u,maxTicks:h,maxDigits:d,includeBounds:p}=n,y=r||1,S=h-1,{min:b,max:T}=t,P=!_t(o),k=!_t(a),C=!_t(u),R=(T-b)/(d+1);let M=Wd((T-b)/S/y)*y,L,E,g,_;if(M<1e-14&&!P&&!k)return[{value:b},{value:T}];_=Math.ceil(T/M)-Math.floor(b/M),_>S&&(M=Wd(_*M/S/y)*y),_t(l)||(L=Math.pow(10,l),M=Math.ceil(M*L)/L),s==="ticks"?(E=Math.floor(b/M)*M,g=Math.ceil(T/M)*M):(E=b,g=T),P&&k&&r&&GS((a-o)/r,M/1e3)?(_=Math.round(Math.min((a-o)/M,h)),M=(a-o)/_,E=o,g=a):C?(E=P?o:E,g=k?a:g,_=u-1,M=(g-E)/_):(_=(g-E)/M,er(_,Math.round(_),M/1e3)?_=Math.round(_):_=Math.ceil(_));const v=Math.max(qd(M),qd(E));L=Math.pow(10,_t(l)?v:l),E=Math.round(E*L)/L,g=Math.round(g*L)/L;let I=0;for(P&&(p&&E!==o?(e.push({value:o}),E<o&&I++,er(Math.round((E+I*M)*L)/L,o,Qf(o,R,n))&&I++):E<o&&I++);I<_;++I){const A=Math.round((E+I*M)*L)/L;if(k&&A>a)break;e.push({value:A})}return k&&p&&g!==a?e.length&&er(e[e.length-1].value,a,Qf(a,R,n))?e[e.length-1].value=a:e.push({value:a}):(!k||g===a)&&e.push({value:g}),e}function Qf(n,t,{horizontal:e,minRotation:i}){const s=fn(i),r=(e?Math.sin(s):Math.cos(s))||.001,o=.75*t*(""+n).length;return Math.min(t/r,o)}class Bk extends ms{constructor(t){super(t),this.start=void 0,this.end=void 0,this._startValue=void 0,this._endValue=void 0,this._valueRange=0}parse(t,e){return _t(t)||(typeof t=="number"||t instanceof Number)&&!isFinite(+t)?null:+t}handleTickRangeOptions(){const{beginAtZero:t}=this.options,{minDefined:e,maxDefined:i}=this.getUserBounds();let{min:s,max:r}=this;const o=l=>s=e?s:l,a=l=>r=i?r:l;if(t){const l=Ye(s),u=Ye(r);l<0&&u<0?a(0):l>0&&u>0&&o(0)}if(s===r){let l=r===0?1:Math.abs(r*.05);a(r+l),t||o(s-l)}this.min=s,this.max=r}getTickLimit(){const t=this.options.ticks;let{maxTicksLimit:e,stepSize:i}=t,s;return i?(s=Math.ceil(this.max/i)-Math.floor(this.min/i)+1,s>1e3&&(console.warn(`scales.${this.id}.ticks.stepSize: ${i} would result generating up to ${s} ticks. Limiting to 1000.`),s=1e3)):(s=this.computeTickLimit(),e=e||11),e&&(s=Math.min(e,s)),s}computeTickLimit(){return Number.POSITIVE_INFINITY}buildTicks(){const t=this.options,e=t.ticks;let i=this.getTickLimit();i=Math.max(2,i);const s={maxTicks:i,bounds:t.bounds,min:t.min,max:t.max,precision:e.precision,step:e.stepSize,count:e.count,maxDigits:this._maxDigits(),horizontal:this.isHorizontal(),minRotation:e.minRotation||0,includeBounds:e.includeBounds!==!1},r=this._range||this,o=zk(s,r);return t.bounds==="ticks"&&YS(o,this,"value"),t.reverse?(o.reverse(),this.start=this.max,this.end=this.min):(this.start=this.min,this.end=this.max),o}configure(){const t=this.ticks;let e=this.min,i=this.max;if(super.configure(),this.options.offset&&t.length){const s=(i-e)/Math.max(t.length-1,1)/2;e-=s,i+=s}this._startValue=e,this._endValue=i,this._valueRange=i-e}getLabelForValue(t){return hu(t,this.chart.options.locale,this.options.ticks.format)}}class cc extends Bk{determineDataLimits(){const{min:t,max:e}=this.getMinMax(!0);this.min=de(t)?t:0,this.max=de(e)?e:1,this.handleTickRangeOptions()}computeTickLimit(){const t=this.isHorizontal(),e=t?this.width:this.height,i=fn(this.options.ticks.minRotation),s=(t?Math.sin(i):Math.cos(i))||.001,r=this._resolveTickFontOptions(0);return Math.ceil(e/Math.min(40,r.lineHeight/s))}getPixelForValue(t){return t===null?NaN:this.getPixelForDecimal((t-this._startValue)/this._valueRange)}getValueForPixel(t){return this._startValue+this.getDecimalForPixel(t)*this._valueRange}}z(cc,"id","linear"),z(cc,"defaults",{ticks:{callback:Km.formatters.numeric}});const Na={millisecond:{common:!0,size:1,steps:1e3},second:{common:!0,size:1e3,steps:60},minute:{common:!0,size:6e4,steps:60},hour:{common:!0,size:36e5,steps:24},day:{common:!0,size:864e5,steps:30},week:{common:!1,size:6048e5,steps:4},month:{common:!0,size:2628e6,steps:12},quarter:{common:!1,size:7884e6,steps:4},year:{common:!0,size:3154e7}},me=Object.keys(Na);function Xf(n,t){return n-t}function Jf(n,t){if(_t(t))return null;const e=n._adapter,{parser:i,round:s,isoWeekday:r}=n._parseOpts;let o=t;return typeof i=="function"&&(o=i(o)),de(o)||(o=typeof i=="string"?e.parse(o,i):e.parse(o)),o===null?null:(s&&(o=s==="week"&&(os(r)||r===!0)?e.startOf(o,"isoWeek",r):e.startOf(o,s)),+o)}function Zf(n,t,e,i){const s=me.length;for(let r=me.indexOf(n);r<s-1;++r){const o=Na[me[r]],a=o.steps?o.steps:Number.MAX_SAFE_INTEGER;if(o.common&&Math.ceil((e-t)/(a*o.size))<=i)return me[r]}return me[s-1]}function jk(n,t,e,i,s){for(let r=me.length-1;r>=me.indexOf(e);r--){const o=me[r];if(Na[o].common&&n._adapter.diff(s,i,o)>=t-1)return o}return me[e?me.indexOf(e):0]}function Hk(n){for(let t=me.indexOf(n)+1,e=me.length;t<e;++t)if(Na[me[t]].common)return me[t]}function tp(n,t,e){if(!e)n[t]=!0;else if(e.length){const{lo:i,hi:s}=cu(e,t),r=e[i]>=t?e[i]:e[s];n[r]=!0}}function Wk(n,t,e,i){const s=n._adapter,r=+s.startOf(t[0].value,i),o=t[t.length-1].value;let a,l;for(a=r;a<=o;a=+s.add(a,1,i))l=e[a],l>=0&&(t[l].major=!0);return t}function ep(n,t,e){const i=[],s={},r=t.length;let o,a;for(o=0;o<r;++o)a=t[o],s[a]=o,i.push({value:a,major:!1});return r===0||!e?i:Wk(n,i,s,e)}class ua extends ms{constructor(t){super(t),this._cache={data:[],labels:[],all:[]},this._unit="day",this._majorUnit=void 0,this._offsets={},this._normalized=!1,this._parseOpts=void 0}init(t,e={}){const i=t.time||(t.time={}),s=this._adapter=new kA._date(t.adapters.date);s.init(e),tr(i.displayFormats,s.formats()),this._parseOpts={parser:i.parser,round:i.round,isoWeekday:i.isoWeekday},super.init(t),this._normalized=e.normalized}parse(t,e){return t===void 0?null:Jf(this,t)}beforeLayout(){super.beforeLayout(),this._cache={data:[],labels:[],all:[]}}determineDataLimits(){const t=this.options,e=this._adapter,i=t.time.unit||"day";let{min:s,max:r,minDefined:o,maxDefined:a}=this.getUserBounds();function l(u){!o&&!isNaN(u.min)&&(s=Math.min(s,u.min)),!a&&!isNaN(u.max)&&(r=Math.max(r,u.max))}(!o||!a)&&(l(this._getLabelBounds()),(t.bounds!=="ticks"||t.ticks.source!=="labels")&&l(this.getMinMax(!1))),s=de(s)&&!isNaN(s)?s:+e.startOf(Date.now(),i),r=de(r)&&!isNaN(r)?r:+e.endOf(Date.now(),i)+1,this.min=Math.min(s,r-1),this.max=Math.max(s+1,r)}_getLabelBounds(){const t=this.getLabelTimestamps();let e=Number.POSITIVE_INFINITY,i=Number.NEGATIVE_INFINITY;return t.length&&(e=t[0],i=t[t.length-1]),{min:e,max:i}}buildTicks(){const t=this.options,e=t.time,i=t.ticks,s=i.source==="labels"?this.getLabelTimestamps():this._generate();t.bounds==="ticks"&&s.length&&(this.min=this._userMin||s[0],this.max=this._userMax||s[s.length-1]);const r=this.min,o=this.max,a=tx(s,r,o);return this._unit=e.unit||(i.autoSkip?Zf(e.minUnit,this.min,this.max,this._getLabelCapacity(r)):jk(this,a.length,e.minUnit,this.min,this.max)),this._majorUnit=!i.major.enabled||this._unit==="year"?void 0:Hk(this._unit),this.initOffsets(s),t.reverse&&a.reverse(),ep(this,a,this._majorUnit)}afterAutoSkip(){this.options.offsetAfterAutoskip&&this.initOffsets(this.ticks.map(t=>+t.value))}initOffsets(t=[]){let e=0,i=0,s,r;this.options.offset&&t.length&&(s=this.getDecimalForValue(t[0]),t.length===1?e=1-s:e=(this.getDecimalForValue(t[1])-s)/2,r=this.getDecimalForValue(t[t.length-1]),t.length===1?i=r:i=(r-this.getDecimalForValue(t[t.length-2]))/2);const o=t.length<3?.5:.25;e=ue(e,0,o),i=ue(i,0,o),this._offsets={start:e,end:i,factor:1/(e+1+i)}}_generate(){const t=this._adapter,e=this.min,i=this.max,s=this.options,r=s.time,o=r.unit||Zf(r.minUnit,e,i,this._getLabelCapacity(e)),a=it(s.ticks.stepSize,1),l=o==="week"?r.isoWeekday:!1,u=os(l)||l===!0,h={};let d=e,p,y;if(u&&(d=+t.startOf(d,"isoWeek",l)),d=+t.startOf(d,u?"day":o),t.diff(i,e,o)>1e5*a)throw new Error(e+" and "+i+" are too far apart with stepSize of "+a+" "+o);const S=s.ticks.source==="data"&&this.getDataTimestamps();for(p=d,y=0;p<i;p=+t.add(p,a,o),y++)tp(h,p,S);return(p===i||s.bounds==="ticks"||y===1)&&tp(h,p,S),Object.keys(h).sort(Xf).map(b=>+b)}getLabelForValue(t){const e=this._adapter,i=this.options.time;return i.tooltipFormat?e.format(t,i.tooltipFormat):e.format(t,i.displayFormats.datetime)}format(t,e){const s=this.options.time.displayFormats,r=this._unit,o=e||s[r];return this._adapter.format(t,o)}_tickFormatFunction(t,e,i,s){const r=this.options,o=r.ticks.callback;if(o)return Rt(o,[t,e,i],this);const a=r.time.displayFormats,l=this._unit,u=this._majorUnit,h=l&&a[l],d=u&&a[u],p=i[e],y=u&&d&&p&&p.major;return this._adapter.format(t,s||(y?d:h))}generateTickLabels(t){let e,i,s;for(e=0,i=t.length;e<i;++e)s=t[e],s.label=this._tickFormatFunction(s.value,e,t)}getDecimalForValue(t){return t===null?NaN:(t-this.min)/(this.max-this.min)}getPixelForValue(t){const e=this._offsets,i=this.getDecimalForValue(t);return this.getPixelForDecimal((e.start+i)*e.factor)}getValueForPixel(t){const e=this._offsets,i=this.getDecimalForPixel(t)/e.factor-e.end;return this.min+i*(this.max-this.min)}_getLabelSize(t){const e=this.options.ticks,i=this.ctx.measureText(t).width,s=fn(this.isHorizontal()?e.maxRotation:e.minRotation),r=Math.cos(s),o=Math.sin(s),a=this._resolveTickFontOptions(0).size;return{w:i*r+a*o,h:i*o+a*r}}_getLabelCapacity(t){const e=this.options.time,i=e.displayFormats,s=i[e.unit]||i.millisecond,r=this._tickFormatFunction(t,0,ep(this,[t],this._majorUnit),s),o=this._getLabelSize(r),a=Math.floor(this.isHorizontal()?this.width/o.w:this.height/o.h)-1;return a>0?a:1}getDataTimestamps(){let t=this._cache.data||[],e,i;if(t.length)return t;const s=this.getMatchingVisibleMetas();if(this._normalized&&s.length)return this._cache.data=s[0].controller.getAllParsedValues(this);for(e=0,i=s.length;e<i;++e)t=t.concat(s[e].controller.getAllParsedValues(this));return this._cache.data=this.normalize(t)}getLabelTimestamps(){const t=this._cache.labels||[];let e,i;if(t.length)return t;const s=this.getLabels();for(e=0,i=s.length;e<i;++e)t.push(Jf(this,s[e]));return this._cache.labels=this._normalized?t:this.normalize(t)}normalize(t){return zm(t.sort(Xf))}}z(ua,"id","time"),z(ua,"defaults",{bounds:"data",adapters:{},time:{parser:!1,unit:!1,round:!1,isoWeekday:!1,minUnit:"millisecond",displayFormats:{}},ticks:{source:"auto",callback:!1,major:{enabled:!1}}});function po(n,t,e){let i=0,s=n.length-1,r,o,a,l;e?(t>=n[i].pos&&t<=n[s].pos&&({lo:i,hi:s}=fi(n,"pos",t)),{pos:r,time:a}=n[i],{pos:o,time:l}=n[s]):(t>=n[i].time&&t<=n[s].time&&({lo:i,hi:s}=fi(n,"time",t)),{time:r,pos:a}=n[i],{time:o,pos:l}=n[s]);const u=o-r;return u?a+(l-a)*(t-r)/u:a}class np extends ua{constructor(t){super(t),this._table=[],this._minPos=void 0,this._tableRange=void 0}initOffsets(){const t=this._getTimestampsForTable(),e=this._table=this.buildLookupTable(t);this._minPos=po(e,this.min),this._tableRange=po(e,this.max)-this._minPos,super.initOffsets(t)}buildLookupTable(t){const{min:e,max:i}=this,s=[],r=[];let o,a,l,u,h;for(o=0,a=t.length;o<a;++o)u=t[o],u>=e&&u<=i&&s.push(u);if(s.length<2)return[{time:e,pos:0},{time:i,pos:1}];for(o=0,a=s.length;o<a;++o)h=s[o+1],l=s[o-1],u=s[o],Math.round((h+l)/2)!==u&&r.push({time:u,pos:o/(a-1)});return r}_generate(){const t=this.min,e=this.max;let i=super.getDataTimestamps();return(!i.includes(t)||!i.length)&&i.splice(0,0,t),(!i.includes(e)||i.length===1)&&i.push(e),i.sort((s,r)=>s-r)}_getTimestampsForTable(){let t=this._cache.all||[];if(t.length)return t;const e=this.getDataTimestamps(),i=this.getLabelTimestamps();return e.length&&i.length?t=this.normalize(e.concat(i)):t=e.length?e:i,t=this._cache.all=t,t}getDecimalForValue(t){return(po(this._table,t)-this._minPos)/this._tableRange}getValueForPixel(t){const e=this._offsets,i=this.getDecimalForPixel(t)/e.factor-e.end;return po(this._table,i*this._tableRange+this._minPos,!0)}}z(np,"id","timeseries"),z(np,"defaults",ua.defaults);cn.register(Po,Ao,js,ko,Fn,Mo,Do,Ws,lc,cc,Tk,kk,Nk);const go={};function Lr(n,t){const e=document.getElementById(n);if(!e)return null;go[n]&&go[n].destroy();const i=e.getContext("2d");return go[n]=new cn(i,t),go[n]}const ip="rgba(148, 163, 184, 0.08)",sr="#64748b",_i="Inter, sans-serif",ye={x:{grid:{color:ip,drawBorder:!1},ticks:{color:sr,font:{family:_i,size:11}}},y:{grid:{color:ip,drawBorder:!1},ticks:{color:sr,font:{family:_i,size:11}}}},vn={legend:{display:!1},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.95)",titleFont:{family:_i,size:12},bodyFont:{family:_i,size:12},padding:10,cornerRadius:8,borderColor:"rgba(148, 163, 184, 0.2)",borderWidth:1}};function qk(n){n.length&&Lr("chart-equity",{type:"line",data:{labels:n.map(t=>t.date),datasets:[{label:"Equity",data:n.map(t=>t.equity),borderColor:"#818cf8",backgroundColor:"rgba(129, 140, 248, 0.1)",fill:!0,borderWidth:2,tension:.3,pointRadius:0,pointHoverRadius:4,pointHoverBackgroundColor:"#818cf8"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{...vn,tooltip:{...vn.tooltip,callbacks:{label:t=>`P&L: $${t.parsed.y.toFixed(2)}`}}},scales:{...ye,y:{...ye.y,ticks:{...ye.y.ticks,callback:t=>"$"+t.toLocaleString()}}}}})}function Kk(n){n.length&&Lr("chart-daily",{type:"bar",data:{labels:n.map(t=>t.date),datasets:[{label:"P&L",data:n.map(t=>t.pnl),backgroundColor:n.map(t=>t.pnl>=0?"rgba(34, 197, 94, 0.7)":"rgba(239, 68, 68, 0.7)"),borderColor:n.map(t=>t.pnl>=0?"#22c55e":"#ef4444"),borderWidth:1,borderRadius:4}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{...vn,tooltip:{...vn.tooltip,callbacks:{label:t=>`P&L: $${t.parsed.y.toFixed(2)}`}}},scales:{...ye,y:{...ye.y,ticks:{...ye.y.ticks,callback:t=>"$"+t.toLocaleString()}}}}})}function Gk(n){n.length&&Lr("chart-coins",{type:"bar",data:{labels:n.map(t=>t.coin),datasets:[{label:"P&L",data:n.map(t=>t.pnl),backgroundColor:n.map(t=>t.pnl>=0?"rgba(34, 197, 94, 0.7)":"rgba(239, 68, 68, 0.7)"),borderColor:n.map(t=>t.pnl>=0?"#22c55e":"#ef4444"),borderWidth:1,borderRadius:4}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:{...vn,tooltip:{...vn.tooltip,callbacks:{label:t=>`P&L: $${t.parsed.x.toFixed(2)}`}}},scales:{x:{...ye.x,ticks:{...ye.x.ticks,callback:t=>"$"+t.toLocaleString()}},y:ye.y}}})}function Yk(n){n.length&&Lr("chart-strategies",{type:"bar",data:{labels:n.map(t=>t.strategy),datasets:[{label:"P&L",data:n.map(t=>t.pnl),backgroundColor:n.map(t=>t.pnl>=0?"rgba(34, 197, 94, 0.7)":"rgba(239, 68, 68, 0.7)"),borderColor:n.map(t=>t.pnl>=0?"#22c55e":"#ef4444"),borderWidth:1,borderRadius:4}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:vn,scales:{x:{...ye.x,ticks:{...ye.x.ticks,callback:t=>"$"+t.toLocaleString()}},y:ye.y}}})}function Qk(n){if(!n.length)return;const t=n.filter(i=>i.isWin),e=n.filter(i=>!i.isWin);Lr("chart-maemfe",{type:"scatter",data:{datasets:[{label:"Wins",data:t.map(i=>({x:i.mae,y:i.mfe})),backgroundColor:"rgba(34, 197, 94, 0.6)",borderColor:"#22c55e",pointRadius:6,pointHoverRadius:8},{label:"Losses",data:e.map(i=>({x:i.mae,y:i.mfe})),backgroundColor:"rgba(239, 68, 68, 0.6)",borderColor:"#ef4444",pointRadius:6,pointHoverRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{...vn,legend:{display:!0,labels:{color:sr,font:{family:_i}}},tooltip:{...vn.tooltip,callbacks:{label:i=>`MAE: ${i.parsed.x}% | MFE: ${i.parsed.y}%`}}},scales:{x:{...ye.x,title:{display:!0,text:"MAE%",color:sr,font:{family:_i}}},y:{...ye.y,title:{display:!0,text:"MFE%",color:sr,font:{family:_i}}}}}})}function Xk(n,t,e,i,s){requestAnimationFrame(()=>{qk(n),Kk(t),Gk(e),Yk(i),Qk(s)})}function Jk(n,t,e){t.innerHTML=`
      ...
      <tbody>
        ${t.map(([e,i])=>`
          <tr>
            ...
            <td class="${i.winRate>=50?"text-profit":"text-loss"}">${Hi(i.winRate)}</td>
  ...
  `}function tR(n,t,e,i){const s=[],r=Object.entries(i||{});if(r.length>0){const y=r.reduce((b,T)=>b[1].totalPnl>T[1].totalPnl?b:T),S=r.reduce((b,T)=>b[1].totalPnl<T[1].totalPnl?b:T);s.push(`🪙 <strong>Most profitable coin</strong>: ${y[0]} (${$t(y[1].totalPnl)}, ${Hi(y[1].winRate)} win rate, ${y[1].closingTrades} trades)`),S[0]!==y[0]&&s.push(`📉 <strong>Weakest coin</strong>: ${S[0]} (${$t(S[1].totalPnl)}, ${Hi(S[1].winRate)} win rate, ${S[1].closingTrades} trades)`)}const o=Object.entries(t);if(o.length>0){const y=o.reduce((b,T)=>b[1].totalPnl>T[1].totalPnl?b:T),S=o.reduce((b,T)=>b[1].totalPnl<T[1].totalPnl?b:T);s.push(`✅ <strong>Best strategy</strong>: ${y[0]} (${$t(y[1].totalPnl)}, ${Hi(y[1].winRate)} win rate)`),S[0]!==y[0]&&s.push(`❌ <strong>Worst strategy</strong>: ${S[0]} (${$t(S[1].totalPnl)}, ${Hi(S[1].winRate)} win rate)`)}const a=Object.entries(e);if(a.length>0){const y=a.reduce((S,b)=>S[1].profitFactor>b[1].profitFactor?S:b);s.push(`⚡ <strong>Best risk/reward ratio</strong>: ${y[0]} (PF: ${y[1].profitFactor===1/0?"∞":y[1].profitFactor.toFixed(2)})`)}const l=[...n].filter(y=>y.closedPnl!==0).sort((y,S)=>y.time.localeCompare(S.time));let u=0,h=0,d=0,p=0;return l.forEach(y=>{y.closedPnl>0?(d++,p=0,u=Math.max(u,d)):(p++,d=0,h=Math.max(h,p))}),s.push(`🔥 <strong>Max win streak</strong>: ${u} consecutive trades`),s.push(`💀 <strong>Max loss streak</strong>: ${h} consecutive trades`),`
  ...
  `}function iR(n,t,e){const i=t.filter(u=>u.time&&u.time.slice(0,10)===n||u.exitTime&&u.exitTime.slice(0,10)===n?!0:u.legs?u.legs.some(h=>h.time&&h.time.slice(0,10)===n):!1),s=[];i.forEach(u=>{const h=(u.legs||[]).filter(d=>d.time&&d.time.slice(0,10)===n);if(h.length>0)h.forEach(d=>{const p=u.direction==="Long"?"long":"short",y=d.type==="exit"&&d.pnl||0,S=y>0?"cell-profit":y<0?"cell-loss":"",b=new Date(d.time).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"});s.push(`
    ...
    `,document.body.appendChild(l),l.querySelector("#day-detail-close").addEventListener("click",()=>l.remove()),l.addEventListener("click",u=>{u.target===l&&l.remove()})}function sR(n,t){const e=Math.abs(n)/t;return e<.15?1:e<.35?2:e<.65?3:4}function rR(n){return Math.abs(n)>=1e3?(n>=0?"+":"")+(n/1e3).toFixed(1)+"k":(n>=0?"+":"")+n.toFixed(0)}let xt=[],x_="dashboard";async function ha(n){Pa(n);const t=document.getElementById("sync-status");t&&(t.textContent="☁️ Syncing...");try{await nu(),t&&(t.textContent="☁️ Synced")}catch(e){console.warn("Cloud sync failed:",e),t&&(t.textContent="⚠️ Offline")}}const ji=document.getElementById("main-content"),A_=document.getElementById("modal-overlay"),P_=document.getElementById("modal-container");document.querySelectorAll(".nav-link").forEach(n=>{n.addEventListener("click",t=>{t.preventDefault();const e=n.dataset.page;e&&k_(e)})});function k_(n){var t;x_=n,document.querySelectorAll(".nav-link").forEach(e=>e.classList.remove("active")),(t=document.querySelector(`[data-page="${n}"]`))==null||t.classList.add("active"),xi()}function xi(){if(!getCurrentUser()){ji.innerHTML=`
      ...
      `;return}switch(x_){case"dashboard":if(tS(xt,ji),xt.length>0){const n=GI(xt),t=su(xt),e=YI(xt),i=QI(xt),s=XI(xt);Xk(n,t,e,i,s)}break;case"trades":Ca(xt,ji,oR);break;case"insights":Zk(xt,ji);break;case"calendar":eR(xt,ji);break}}function oR(n){pS(n,ji,()=>{k_("trades")},(t,e)=>{xt=xt.map(i=>i.id===t?{...i,...e}:i),ha(xt)},t=>{xt=xt.filter(e=>e.id!==t),ha(xt)})}function aR(n){xt=BI(xt,n),ha(xt),xi()}function lR(n){const t=xt.findIndex(e=>e.coin===n.coin&&e.direction===n.direction);if(t!==-1){const e=xt[t],i=[...e.legs||[],...n.legs||[]],s=ea(i,e.direction),r=On(s);xt[t]={...e,legs:s,...r,exitTime:r.status==="Completed"?new Date().toISOString():null}}else xt.push(n);ha(xt),xi()}document.getElementById("btn-import-csv").addEventListener("click",()=>{Jk(A_,P_,aR)});document.getElementById("btn-add-trade").addEventListener("click",()=>{dS(A_,P_,lR)});document.getElementById("btn-export-data").addEventListener("click",async()=>{try{const n=await kI(),t=JSON.stringify(n,null,2),e=new Blob([t],{type:"application/json"}),i=URL.createObjectURL(e),s=document.createElement("a");s.href=i,s.download=`crypto-journal-backup-${new Date().toISOString().slice(0,10)}.json`,s.click(),URL.revokeObjectURL(i)}catch(n){console.error("Export failed:",n),alert("Export error: "+n.message)}});document.getElementById("btn-import-data").addEventListener("click",()=>{const n=document.createElement("input");n.type="file",n.accept=".json",n.addEventListener("change",async t=>{var i;const e=t.target.files[0];if(e)try{const s=await e.text(),r=JSON.parse(s);await RI(r),xt=ka(),xi(),alert(`✅ Backup imported! (${((i=r.trades)==null?void 0:i.length)||0} trades)`)}catch(s){console.error("Import failed:",s),alert("Import error: "+s.message)}}),n.click()});document.getElementById("lightbox-close").addEventListener("click",()=>{document.getElementById("lightbox").classList.add("hidden")});document.getElementById("lightbox").addEventListener("click",n=>{n.target===n.currentTarget&&n.currentTarget.classList.add("hidden")});const bu=document.getElementById("hamburger"),R_=document.getElementById("sidebar"),vu=document.getElementById("sidebar-backdrop");function cR(){R_.classList.toggle("open"),bu.classList.toggle("open"),vu.classList.toggle("open")}function Eu(){R_.classList.remove("open"),bu.classList.remove("open"),vu.classList.remove("open")}bu.addEventListener("click",cR);vu.addEventListener("click",Eu);document.querySelectorAll(".nav-link").forEach(n=>{n.addEventListener("click",Eu)});["btn-import-csv","btn-add-trade","btn-export-data","btn-import-data"].forEach(n=>{var t;(t=document.getElementById(n))==null||t.addEventListener("click",Eu)});const rp=document.getElementById("auth-logged-out"),op=document.getElementById("auth-logged-in"),uR=document.getElementById("auth-avatar"),hR=document.getElementById("auth-name");document.getElementById("btn-google-login").addEventListener("click",async()=>{try{await bI()}catch(n){n.code!=="auth/popup-closed-by-user"&&(console.error("Login failed:",n),alert("Login failed: "+n.message))}});document.getElementById("btn-logout").addEventListener("click",async()=>{await vI()});EI(async n=>{if(n){Od(n.uid),rp.classList.add("hidden"),op.classList.remove("hidden"),uR.src=n.photoURL||"",hR.textContent=n.displayName||n.email;const t=document.getElementById("sync-status");t.textContent="☁️ Loading...",await xI()?(xt=HI(jI(ka())),xi()):await nu(),t.textContent="☁️ Synced"}else Od(null),rp.classList.remove("hidden"),op.classList.add("hidden"),Pa([]),xt=[],xi()});xi();
